...
from datasets.dtu_both_relative8_withSurf import DTUDataset # --> new conversion, includes reading KPS files
...
outdir = "./ckpts/esh_RT_SURF/" + args.exp_name + "/"

if not os.path.exists(outdir):
    os.mkdir(outdir)

outdir = "./ckpts/esh_RT_SURF/" + args.exp_name + "/" + "trainResults"
...
LogDir = "./ckpts/esh_RT_SURF/" + args.exp_name + "/trainLog_" + str(datetime.datetime.now()) + ".log"
...
if args.trainRT_net:
    ...
    model_save_path = "./ckpts/esh_RT_SURF/" + args.exp_name
