...
class DTUDataset(Dataset):
    ...
    def Get_HOG_Descriptor(self, image):
        ...
        (H, hogImage) = hog(image, orientations=9, pixels_per_cell=(16, 16),cells_per_block=(1, 1), transform_sqrt=True, block_norm="L1", visualize=True)
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            img_filename = os.path.join('./HoGImgs_folder/',f'{scan}_train/rect_{vid+1:03d}_{light_idx}_r5000.png')
            ...
            #HoG_img = self.Get_HOG_Descriptor(img_cpy)  # compute the HoG features before transforming the image
