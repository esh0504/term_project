                    ...
                    for y in range(len(src_views)):
                        if (self.split == 'train'):
                            ...
                            for light_idx in range(7):
                                self.metas += [(scan, light_idx, ref_view, src_views[y])]  # use only a pair of 2 (1 ref and 1 src image), use all the combinations

                        if (self.split == 'test'):
                            # light conditions 0 'only use lighting condition 0
                            for light_idx in range(1):
                                self.metas += [(scan, light_idx, ref_view, src_views[y])]
