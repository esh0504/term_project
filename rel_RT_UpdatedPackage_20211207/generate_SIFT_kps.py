...
root_dir = '../datasets/zahid_data/MVSNet_pl/MVSNet_pl/datasets/train_data/dtu/'

all_proj_mats = build_proj_mats(root_dir)

dtu_dataset_folder = '../datasets/zahid_data/MVSNet_pl/MVSNet_pl/datasets/train_data/dtu/Rectified/'
...
for file_count in range(117, len(foldernames)): # get the filenames in each folder of dtu dataset
