...
# 조사할 디렉토리 경로
ROOT_DIR = '/home/gpuadmin/Seungho/rel_RT_UpdatedPackage_20211207/keypoints'
...
print(f'Zahid\'s KEYPOINTS 총 갯수: 총 {total_line_count} 개\n')
print(f'파일당 평균 KEYPOINTS 갯수 : {total_line_count/total_file_count} 개 / 파일')